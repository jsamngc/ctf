...
const LKLCard : React.FC<LKLCard> = ({lklData} : LKLCard) => {
    ...
    const { isOpen: isDeactivateOpen, 
        onOpen: onDeactivateOpen, 
        onClose: onDeactivateClose } = useDisclosure()
    ...
    const {
        ...
        lklAddressDto,
        lklPocListDto
    } : LookupLklDto = lklData.lookupLklDto
    const {
        address1,
        address2,
        city,
    ...
    lklPocListDto.map((lklPocListDto : LklPocListDto) => {
        ...
        const {
            ...
            personEmailDtoList,
            personPhoneDtoList
        } : PersonDto = lklPocListDto.personDto
            ...
            <Card id="lklCard" maxWidth="full">
                <Flex flexDir={{base: "column", xl: "row"}} position="absolute" w="full" top={{ base: "-8px", sm: "-16px" }} >
                    ...
                    <Box mb={4} flexBasis={{xl:"35%"}} >
                        <FinePrint color="label">U.S. Embassy in {city}, {countryCd}</FinePrint>
                    </Box>
                </Flex>
                <Box
                    position="absolute"
                        ...
                        <Box display={{xl: "none"}}>
                            <Flex mb={16} >
                                <PseudoBox 
                                    ...
                                    borderBottomColor="pictionBlue" 
                                    borderStyle="solid"
                                    _hover={tabCurrent ? {} : {
                                        color: "lochmara",
                                        borderBottomColor: "lochmara",
                                        borderBottom : "3px",
                                        borderStyle : "solid"
                                    }}
                                    onClick={() => {
